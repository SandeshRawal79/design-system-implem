            ...
            <Table className="responsive-table">
              <TableHeader data-slot="table-header" className="[&_tr]:border-b sticky-header">
                <TableRow data-slot="table-row" className="hover:bg-muted/50 data-[state=selected]:bg-muted border-b transition-colors">
                  <TableHead data-slot="table-head" className="text-foreground h-10 px-2 text-left align-middle font-medium whitespace-nowrap [&:has([role=checkbox])]:pr-0 [&>[role=checkbox]]:translate-y-[2px] bg-card border-r border-border">
                ...
                {filteredAndSortedData.map((record, index) => (
                  ...
                  >
                    <TableCell 
                      ...
                      className="h-12 px-2 text-left align-middle font-medium text-sm text-foreground [&:has([role=checkbox])]:pr-0 [&>[role=checkbox]]:translate-y-[2px] text-center font-semibold text-primary border-r border-border"
                      role="gridcell"
                    ...
                    <TableCell 
                      data-slot="table-cell"
                      className="h-12 px-2 text-left align-middle font-medium text-sm text-foreground [&:has([role=checkbox])]:pr-0 [&>[role=checkbox]]:translate-y-[2px] border-r border-border"
                      role="gridcell"
                    >
                      <Button 
                        variant="link" 
                    ...
                    <TableCell 
                      data-slot="table-cell"
                      className="h-12 px-2 text-left align-middle font-medium text-sm text-foreground [&:has([role=checkbox])]:pr-0 [&>[role=checkbox]]:translate-y-[2px] text-center border-r border-border"
                      role="gridcell"
                    >
