          ...
          <div className="flex items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-2">
              ...
              <Input
                ...
                min="0"
                max="100"
                className="w-20 border-input font-bold text-accent transition-all duration-300 focus:ring-2 focus:ring-primary focus:ring-offset-1"
                style={{ height: 'var(--button-sm)', fontSize: 'var(--font-body)' }}
              />
              <Button
                size="sm" 
                className="px-4 btn-gradient-primary font-medium transition-all duration-300 focus:ring-2 focus:ring-primary focus:ring-offset-2"
                style={{ height: 'var(--button-sm)', fontSize: 'var(--font-body)' }}
                onClick={() => {
          ...
          <div className="flex items-center gap-2 px-3 py-2 border-b border-border bg-muted/20 flex-wrap filter-bar flex-shrink-0">
            ...
            <div className="relative flex-1 min-w-64 max-w-80">
              ...
              <Input
                ...
                className="pl-7 pr-7 border-input placeholder:text-muted-foreground transition-all duration-300 focus:ring-2 focus:ring-primary focus:ring-offset-1"
              ...
              {searchTerm && (
                <Button
                  variant="ghost"
                  size="sm"
                  className="absolute right-1 top-1/2 transform -translate-y-1/2 p-0 hover:bg-muted transition-all duration-300"
            ...
            <div className="flex items-center gap-1">
              {['all', 'with-approvals', 'pending-approvals', 'no-approvals'].map((type) => (
                <Button
                  ...
                  className={`${
                    filterType === type 
                      ? type === 'with-approvals' ? 'btn-gradient-primary'
            ...
            <div className="flex items-center gap-1">
              <Select value={statusFilter} onValueChange={(value) => setStatusFilter(value as StatusFilter)}>
                <SelectTrigger className="w-24 border-input transition-all duration-300 focus:ring-2 focus:ring-primary focus:ring-offset-1" style={{ fontSize: 'var(--font-body)', height: 'var(--button-sm)' }}>
                  <SelectValue />
                </SelectTrigger>
                <SelectContent>
              ...
              <Select value={provisionTypeFilter} onValueChange={setProvisionTypeFilter}>
                <SelectTrigger className="w-32 border-input transition-all duration-300 focus:ring-2 focus:ring-primary focus:ring-offset-1" style={{ fontSize: 'var(--font-body)', height: 'var(--button-sm)' }}>
                  <SelectValue />
                </SelectTrigger>
                <SelectContent>
              ...
              <Select value={sortField} onValueChange={(value) => setSortField(value as SortField)}>
                <SelectTrigger className="w-40 border-input transition-all duration-300 focus:ring-2 focus:ring-primary focus:ring-offset-1" style={{ fontSize: 'var(--font-body)', height: 'var(--button-sm)' }}>
                  <SelectValue />
                </SelectTrigger>
                <SelectContent>
              ...
              <Button
                variant="outline"
                size="sm"
                className="px-2 btn-gradient-secondary transition-all duration-300 focus:ring-2 focus:ring-primary focus:ring-offset-2"
            ...
            <div className="flex items-center gap-2 ml-auto">
              ...
              <Button
                ...
                className="px-2 text-muted-foreground hover:text-foreground hover:bg-muted transition-all duration-300 focus:ring-2 focus:ring-primary focus:ring-offset-1"
                style={{ fontSize: 'var(--font-body)', height: 'var(--button-sm)' }}
              >
