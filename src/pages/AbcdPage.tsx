    ...
    <Card className="h-full cursor-pointer hover:shadow-md transition-shadow">
      <CardHeader className="pb-4">
        ...
        <div className="flex items-center gap-2 mt-2">
          <div className={`w-2 h-2 rounded-full ${isActive ? 'bg-success' : 'bg-muted-foreground'}`}></div>
      ...
      <CardContent className="pt-0">
        ...
        <Button 
          size="sm" 
          className="w-full mt-6 btn-gradient-secondary text-primary hover:text-white"
        >
    ...
    <div className="space-y-8">
      ...
      <div className="flex items-center gap-4">
        <Link to="/" className="icon-hover">
          <CaretLeft className="w-6 h-6 text-icon" />
        </Link>
        <div>
          <h1 className="text-h3-responsive font-bold text-foreground">ABCD Disposition</h1>
          <p className="text-sm text-muted-foreground">Healthcare Analytics Platform</p>
        </div>
      </div>
