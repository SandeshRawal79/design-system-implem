...
export function ClusterDetailsView() {
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 items-end">
              ...
              <div className="relative">
                ...
                <Input
                  ...
                  className="pl-10 pr-8 py-2 text-sm h-10 w-full border-border"
                />
                {searchTerm && (
                  <Button
                    variant="ghost"
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-2">
                ...
                <div className="flex gap-1">
                  ...
                  >
                    {sortDirection === 'asc' ? <SortAscending className="h-4 w-4" /> : <SortDescending className="h-4 w-4" />}
                  </Button>
                </div>
              </div>
            </div>
